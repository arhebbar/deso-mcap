...
const WALLET_CONFIG: WalletConfig[] = [
  ...
  { username: '', displayName: 'Foundation (…4knt)', classification: 'FOUNDATION', publicKeyBase58Check: 'BC1YLiyKv1FDuHRTwc6XqLVKp4rHLmDzCU8tDfenLYML1Trh7RT4knt' },
  { username: '', displayName: 'Foundation (…sHue)', classification: 'FOUNDATION', publicKeyBase58Check: 'BC1YLiPCuqJ4ZJfLSc7XfNRWqpXc5G11eUTuH5sCy9LkKCCqNzAsHue' },
  { username: '', displayName: 'Foundation (…ue7R)', classification: 'FOUNDATION', publicKeyBase58Check: 'BC1YLhWip1rXjJYSUMfRGS9LvKAro6Age1bTqqs69PnpkjC3cDEue7R' },
  ...
  { username: 'AMM_DESO_24_PlAEU', classification: 'FOUNDATION' },
  { username: 'AMM_DESO_23_GrYpe', classification: 'FOUNDATION' },
  { username: 'AMM_focus_12_nzWku', classification: 'AMM' },
  { username: 'AMM_openfund_12_gOR1b', classification: 'AMM' },
  { username: 'AMM_DESO_19_W5vn0', classification: 'FOUNDATION' },
  ...
  { username: 'sjg', classification: 'FOUNDER' },
  { username: 'topaz', classification: 'FOUNDER' },
  { username: 'King_Clout', classification: 'FOUNDER' },
  { username: 'diamondhands', classification: 'FOUNDER' },
  ...
  { username: 'DesocialWorld', displayName: 'DesocialWorld (incl. DeSocialWorldValidator, Edokoevoet, DeSocialNL, Post2EarnDAO)', classification: 'DESO_BULL', mergeKey: 'DesocialWorld' },
  { username: 'DesocialWorldValidator', displayName: 'DesocialWorld (incl. DeSocialWorldValidator, Edokoevoet, DeSocialNL, Post2EarnDAO)', classification: 'DESO_BULL', mergeKey: 'DesocialWorld' },
  { username: 'Edokoevoet', displayName: 'DesocialWorld (incl. DeSocialWorldValidator, Edokoevoet, DeSocialNL, Post2EarnDAO)', classification: 'DESO_BULL', mergeKey: 'DesocialWorld' },
  { username: 'DeSocialNL', displayName: 'DesocialWorld (incl. DeSocialWorldValidator, Edokoevoet, DeSocialNL, Post2EarnDAO)', classification: 'DESO_BULL', mergeKey: 'DesocialWorld' },
  { username: 'Post2EarnDAO', displayName: 'DesocialWorld (incl. DeSocialWorldValidator, Edokoevoet, DeSocialNL, Post2EarnDAO)', classification: 'DESO_BULL', mergeKey: 'DesocialWorld' },
  ...
  { username: '0xAustin', displayName: '0xAustin (incl. 0xVault, SocialVentures)', classification: 'DESO_BULL', mergeKey: '0xAustin' },
  { username: '0xVault', displayName: '0xAustin (incl. 0xVault, SocialVentures)', classification: 'DESO_BULL', mergeKey: '0xAustin' },
  { username: '0xAustinValidator', displayName: '0xAustin (incl. 0xVault, SocialVentures)', classification: 'DESO_BULL', mergeKey: '0xAustin' },
  { username: 'SocialVentures', displayName: '0xAustin (incl. 0xVault, SocialVentures)', classification: 'DESO_BULL', mergeKey: '0xAustin' },
  { username: '0xBen_', displayName: '0xBen_ (incl. 0xBen_Validator)', classification: 'DESO_BULL', mergeKey: '0xBen_' },
  { username: '0xBen_Validator', displayName: '0xBen_ (incl. 0xBen_Validator)', classification: 'DESO_BULL', mergeKey: '0xBen_' },
  ...
  { username: 'mcMarsh', displayName: 'mcMarsh (incl. jemarsh, mcMarshstaking, mcmarshKivaFund)', classification: 'DESO_BULL', mergeKey: 'mcMarsh' },
  { username: 'mcMarshstaking', displayName: 'mcMarsh (incl. jemarsh, mcMarshstaking, mcmarshKivaFund)', classification: 'DESO_BULL', mergeKey: 'mcMarsh' },
  { username: 'jemarsh', displayName: 'mcMarsh (incl. jemarsh, mcMarshstaking, mcmarshKivaFund)', classification: 'DESO_BULL', mergeKey: 'mcMarsh' },
  { username: 'mcmarshKivaFund', displayName: 'mcMarsh (incl. jemarsh, mcMarshstaking, mcmarshKivaFund)', classification: 'DESO_BULL', mergeKey: 'mcMarsh' },
  ...
  { username: 'ElizabethTubbs', displayName: 'ElizabethTubbs (incl. TalkIntuition, InMyHumbleOpinion)', classification: 'DESO_BULL', mergeKey: 'ElizabethTubbs' },
  { username: 'TalkIntuition', displayName: 'ElizabethTubbs (incl. TalkIntuition, InMyHumbleOpinion)', classification: 'DESO_BULL', mergeKey: 'ElizabethTubbs' },
  { username: 'InMyHumbleOpinion', displayName: 'ElizabethTubbs (incl. TalkIntuition, InMyHumbleOpinion)', classification: 'DESO_BULL', mergeKey: 'ElizabethTubbs' },
  ...
  { username: 'przemyslawdygdon', displayName: 'przemyslawdygdon (incl. WhatsMy, CoinGeeks)', classification: 'DESO_BULL', mergeKey: 'przemyslawdygdon' },
  { username: 'WhatsMy', displayName: 'przemyslawdygdon (incl. WhatsMy, CoinGeeks)', classification: 'DESO_BULL', mergeKey: 'przemyslawdygdon' },
  { username: 'CoinGeeks', displayName: 'przemyslawdygdon (incl. WhatsMy, CoinGeeks)', classification: 'DESO_BULL', mergeKey: 'przemyslawdygdon' },
  { username: 'Fernando_Pessoa', classification: 'DESO_BULL' },
  { username: 'SkhiBridges', classification: 'DESO_BULL' },
  { username: 'Arnoud', displayName: 'Arnoud (incl. ArnoudvanderPlas)', classification: 'DESO_BULL', mergeKey: 'Arnoud' },
  { username: 'ArnoudvanderPlas', displayName: 'Arnoud (incl. ArnoudvanderPlas)', classification: 'DESO_BULL', mergeKey: 'Arnoud' },
  ...
  { username: 'OliB', displayName: 'OliB (incl. OliBvault, rbvault)', classification: 'DESO_BULL', mergeKey: 'OliB' },
  { username: 'OliBvault', displayName: 'OliB (incl. OliBvault, rbvault)', classification: 'DESO_BULL', mergeKey: 'OliB' },
  { username: 'rbvault', displayName: 'OliB (incl. OliBvault, rbvault)', classification: 'DESO_BULL', mergeKey: 'OliB' },
  ...
  // NFTz and alt
  { username: 'NFTz', displayName: 'NFTz (incl. NFTzToken)', classification: 'DESO_BULL', mergeKey: 'NFTz' },
  { username: 'NFTzToken', displayName: 'NFTz (incl. NFTzToken)', classification: 'DESO_BULL', mergeKey: 'NFTz' },
  // New DeSo Bulls
  { username: 'Hrvat', classification: 'DESO_BULL' },
  { username: 'WNBATopshot', classification: 'DESO_BULL' },
  { username: 'AkshayUpadhyay', classification: 'DESO_BULL' },
  { username: 'Arthurzx', classification: 'DESO_BULL' },
  { username: 'RobertPatrickCampbell', classification: 'DESO_BULL' },
  { username: 'Sajan', classification: 'DESO_BULL' },
  { username: 'HappyRabbit', classification: 'DESO_BULL' },
  { username: 'June_', classification: 'DESO_BULL' },
  { username: 'Florence_A', classification: 'DESO_BULL' },
  { username: 'MANRIKPHOTO', classification: 'DESO_BULL' },
  { username: 'Miniyo2', classification: 'DESO_BULL' },
  { username: 'ShogunXBT', classification: 'DESO_BULL' },
  { username: 'JDArmstrong', classification: 'DESO_BULL' },
  { username: 'Desomon', classification: 'DESO_BULL' },
  { username: 'RealMcoin', classification: 'DESO_BULL' },
  { username: 'TheItinerant', classification: 'DESO_BULL' },
  { username: 'aibolit', classification: 'DESO_BULL' },
  { username: 'DlANA', classification: 'DESO_BULL' },
  { username: 'PlayItForward', classification: 'DESO_BULL' },
  { username: 'phoobiedoo', classification: 'DESO_BULL' },
  { username: 'cloutjacks', classification: 'DESO_BULL' },
  { username: 'DegenDudes', classification: 'DESO_BULL' },
  { username: 'rohitnishad', classification: 'DESO_BULL' },
  { username: 'AmarisChocolate', classification: 'DESO_BULL' },
  { username: 'josh', classification: 'DESO_BULL' },
  { username: 'Octavie', classification: 'DESO_BULL' },
  { username: 'elSjon', classification: 'DESO_BULL' },
  { username: 'Neet', classification: 'DESO_BULL' },
  { username: 'BoopsBoutique', classification: 'DESO_BULL' },
  { username: 'mvanhalen', classification: 'DESO_BULL' },
  { username: 'Draftsman', classification: 'DESO_BULL' },
  { username: 'ohlala', classification: 'DESO_BULL' },
  { username: 'Deaththirst', classification: 'DESO_BULL' },
  { username: 'becopro', classification: 'DESO_BULL' },
  { username: 'deso360', classification: 'DESO_BULL' },
  { username: 'DeSoHosting', classification: 'DESO_BULL' },
  { username: 'WhyIsItTrending', classification: 'DESO_BULL' },
  { username: 'a_bloke', classification: 'DESO_BULL' },
  { username: 'Raviyadav', classification: 'DESO_BULL' },
  { username: 'designal', classification: 'DESO_BULL' },
  { username: 'AnonimInvestor', classification: 'DESO_BULL' },
  { username: 'NamasteJoy', classification: 'DESO_BULL' },
  { username: 'CreatorFundExpenses', classification: 'DESO_BULL' },
  { username: 'SunsetDAM', classification: 'DESO_BULL' },
  { username: 'zackkalter', classification: 'DESO_BULL' },
  { username: 'N1KO', classification: 'DESO_BULL' },
  { username: 'usmansheikh', classification: 'DESO_BULL' },
  { username: 'FreeLife', classification: 'DESO_BULL' },
  { username: 'Prometheus', classification: 'DESO_BULL' },
  { username: 'PMD', classification: 'DESO_BULL' },
  { username: 'Jowekida', classification: 'DESO_BULL' },
  { username: 'CoinWhale', classification: 'DESO_BULL' },
  { username: 'magicvc', classification: 'DESO_BULL' },
  { username: 'TheIdeaGuy', classification: 'DESO_BULL' },
  { username: 'ASG', classification: 'DESO_BULL' },
  { username: 'andrewjnadeau', classification: 'DESO_BULL' },
  { username: 'EtherChad', classification: 'DESO_BULL' },
  { username: 'teddyk', classification: 'DESO_BULL' },
  { username: 'edbaker', classification: 'DESO_BULL' },
  { username: 'daren8', classification: 'DESO_BULL' },
  { username: 'harrycox', classification: 'DESO_BULL' },
  { username: 'Kurkuma', classification: 'DESO_BULL' },
  { username: 'mr_shib', classification: 'DESO_BULL' },
  { username: 'xyzholdings', classification: 'DESO_BULL' },
  { username: 'PickleJoe', classification: 'DESO_BULL' },
  { username: 'JeffreyAlexanderPalomarez', classification: 'DESO_BULL' },
  { username: 'VenusComplexxx', classification: 'DESO_BULL' },
  ...
  { username: 'artz', displayName: 'artz (incl. …7is7, ztra)', classification: 'DESO_BULL', mergeKey: 'artz' },
  { username: '', displayName: 'artz (incl. …7is7, ztra)', classification: 'DESO_BULL', mergeKey: 'artz', publicKeyBase58Check: 'BC1YLj3h9S8zpcTb8Rd4ZBe3Szg2Giokxowg8QkBGt8mJD86Mzo7is7' },
  { username: 'ztra', displayName: 'artz (incl. …7is7, ztra)', classification: 'DESO_BULL', mergeKey: 'artz' },
  ...
  // No Source/Core
  // Core Team (FOUNDER)
  { username: '', displayName: 'Core Team (…fJ9)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLitz3fid4UWR337TPRerkLaFAx55i8XktzU58idKMReciCBDfJ9' },
  { username: '', displayName: 'Core Team (…KeBo)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLjAkTwNw5AKy1TCHT8qjZjmdEojvtNpB7wgFdguZ78scMu3KeBo' },
  { username: '', displayName: 'Core Team (…BHFF)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLhFidFPHVcNGq674VgQxjJgzsjgZZDCiZdTnyHGFzgc34BCBHFF' },
  { username: '', displayName: 'Core Team (…1weS)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLhnXnSKcM4pYxwU3a24bigPJx9LL2gjrmj6mPfv5c771w5B1weS' },
  { username: '', displayName: 'Core Team (…aWbs)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLffz4MC2HZzZdgCahbcBac8Vrsr6mUEDEMrGEkaFr2ux9UqaWbs' },
  { username: '', displayName: 'Core Team (…umt3n)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLirfuVnByxfQk5kwNKyk13oa28mDxb42Uiw9My9LrhMgTkumt3n' },
  { username: '', displayName: 'Core Team (…nfhL)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLiYxGdXeuPc3QMzgBv26EwfxrpwemdGxGZAZbh5qXgf7DennfhL' },
  { username: 'Da5id', classification: 'FOUNDER' },
  { username: '', displayName: 'Core Team (…JKo6)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLiBj1K5DwKKVTYPHzHTPYBaNPDv678PN7kKHwRqjH91KgDKJKo6' },
  { username: '', displayName: 'Core Team (…oEkb)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLfnQurEcFMCaPsmgtnzjDSzNCSCjYYvVLyvWvmYL6nnfrFHoEkb' },
  ...
  { username: '', displayName: 'Core Team (…eTXb)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLj797rLyQJPxEPvWBy9iM5mpCTSdfsXb2LmSAa3TRcLEoTWeTXb' },
  { username: '', displayName: 'Core Team (…W3Av)', classification: 'FOUNDER', publicKeyBase58Check: 'BC1YLgyjPzY82hWq2yuBsPPf5cyg9MsGfJqbFfED1GfEKgJDW9eW3Av' },
  ...
  { username: '', displayName: 'Core Affiliated (…XcsU)', classification: 'CORE_AFFILIATED', publicKeyBase58Check: 'BC1YLhTFNFodyLNLH2fewKAbXVTdSMQmdQbvVgF9jjDF645RRDiXcsU' },
  { username: '', displayName: 'Core Affiliated (…uxPT)', classification: 'CORE_AFFILIATED', publicKeyBase58Check: 'BC1YLi7SdhUxoA15aHFwMshPXcLfQp5ApZPcoQDajr19XvCvGp3uxPT' },
  { username: '', displayName: 'Core Affiliated (…WEseV)', classification: 'CORE_AFFILIATED', publicKeyBase58Check: 'BC1YLgNNPmfT27khvm7mKgzVidj9eNzMBWs3uVYxg4WQiBSiXCWEseV' },
  { username: '', displayName: 'Core Affiliated (…Y6ncP)', classification: 'CORE_AFFILIATED', publicKeyBase58Check: 'BC1YLfh3Kev5GmZamZetaUrbCk16GkpuasVrjZSu2DtA4PvtcaY6ncP' },
  ...
  { username: 'pearl', displayName: 'pearl (incl. …PR7J)', classification: 'CORE_AFFILIATED', mergeKey: 'pearl' },
  { username: '', displayName: 'pearl (incl. …PR7J)', classification: 'CORE_AFFILIATED', mergeKey: 'pearl', publicKeyBase58Check: 'BC1YLjFYcyrfzZBxaQAAtuKnHTE9t8ozbX6VqvN3Ryza8z2cnUAPR7J' },
  // Top 10 CC holders of top 1000 CC coins – reduces Others-Unaccounted CCv1
  ...CCV1_OTHERS_ENTRIES,
  { username: 'craig', displayName: 'craig', classification: 'DESO_BULL', publicKeyBase58Check: 'BC1YLj4iUraQabhUBT8kS1gCieXhD1GGXeFCcU3qM3MGgf7GwBJ9Va7' },
  { username: 'AltcoinUSA', classification: 'DESO_BULL' },
  { username: 'lewishowes', classification: 'DESO_BULL' },
  { username: 'jakezeller', classification: 'DESO_BULL' },
  { username: 'Alisuliman', classification: 'DESO_BULL' },
  { username: 'Rimasul117', classification: 'DESO_BULL' },
