...
const WALLET_CONFIG = [
  ...
  { username: 'StarGeezerCore', classification: 'DESO_BULL', mergeKey: 'StarGeezer' },
  { username: 'BeyondSocial', classification: 'DESO_BULL', mergeKey: 'StarGeezer' },
  ...
  { username: 'Moggel', classification: 'DESO_BULL', mergeKey: 'Moggel' },
  { username: 'BlastingBull67', classification: 'DESO_BULL', mergeKey: 'Moggel' },
  { username: 'SinisterSwine666', classification: 'DESO_BULL', mergeKey: 'Moggel' },
